...
use YiiConfigure\replaceSetting\backend\services\ReplaceSettingSuperService;
 ...
 *
 * @property-read IReplaceSettingSuperService $service
 */
class ReplaceSettingSuperController extends RestController
{
    public $serviceInterface = IReplaceSettingSuperService::class;
    public $serviceClass     = ReplaceSettingSuperService::class;
