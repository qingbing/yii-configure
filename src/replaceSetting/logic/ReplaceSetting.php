...
namespace YiiConfigure\replaceSetting\logic;


use YiiConfigure\replaceSetting\models\ReplaceSetting as ReplaceSettingModel;
...
class ReplaceSetting
{
    ...
    {
        $replaces = array_merge(ReplaceSettingModel::getReplaces(), $replaces);
        $template = $this->record['content'] ?: $this->record['template'];
