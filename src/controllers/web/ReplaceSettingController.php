...
use YiiConfigure\replaceSetting\services\WebReplaceSettingService;
 ...
 *
 * @property-read IWebReplaceSettingService $service
 */
class ReplaceSettingController extends RestController
{
    public $serviceInterface = IWebReplaceSettingService::class;
    public $serviceClass     = WebReplaceSettingService::class;
